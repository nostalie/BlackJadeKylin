...
public class JoinSQL {
    ...
    private JoinSQL(List<ColumnInfo> columnInfoList, CRUDContext context) {
        this.columnInfoList = columnInfoList;
        this.context = context;
    }

    public static JoinSQL onQuery(List<ColumnInfo> columnInfoList, CRUDContext context) {
        return new JoinSQL(columnInfoList,context);
    }

    public static  JoinSQL on(CRUDContext context){
        return onQuery(null,context);
    }
    ...
    private void verify(){
        ...
        Preconditions.checkArgument(!KylinUtils.nullToEmpty(context.getTableInfo().getTableName()).equals(EMPTY),"拼接sql表明不能为空");
    }
    ...
    public JoinSQL selectSQL() {
        try {
            ...
            LOGGER.error("拼接select SQL失败, columnInfo List:{},CRUDContext:{}", columnInfoList, context, e);
    ...
    public JoinSQL insertSQL(){
        try {
            ...
            LOGGER.error("拼接insert SQL失败, columnInfo List:{},CRUDContext:{}", columnInfoList, context, e);
    ...
    public JoinSQL deleteSQL(){
        try{
            ...
            LOGGER.error("拼接delete SQL失败, columnInfo List:{},CRUDContext:{}", columnInfoList, context, e);
    ...
    public JoinSQL updateSQL(){
        try {
            ...
            LOGGER.error("拼接update SQL失败, columnInfo List:{},CRUDContext:{}", columnInfoList, context, e);
    ...
    public JoinSQL withCondition() {
        try {
            ...
            LOGGER.error("拼接condition SQL失败, columnInfo List:{},CRUDContext:{}", columnInfoList, context, e);
    ...
    public JoinSQL withLimit() {
        try {
            ...
            this.sql += SPACE + LIMIT + context.getRowBounds().getOffset() + COMMA + context.getRowBounds().getLimit();
            return this;
        } catch (Exception e) {
            LOGGER.error("拼接limit SQL失败, columnInfo List:{},CRUDContext:{}", columnInfoList, context, e);
